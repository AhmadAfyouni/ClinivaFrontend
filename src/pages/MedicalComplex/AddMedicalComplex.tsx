...
function AddMedicalComplex() {
  ...
  const primaryFields: InputPropsType[] = [
    ...
    },
    {
      ...
      tooltip: "Enter the Medical Complex's email",
    ...
    },
    {
      ...
      tooltip: "Enter the Medical Complex's country",
    ...
    },
    {
      ...
      tooltip: "Enter the Medical Complex's zip code",
    ...
    },
    {
      ...
      placeholder: `https//cliniva.online`,
      tooltip: "Enter the Medical Complex's website",
    ...
    },
    {
      ...
      tooltip: "Enter the Medical Complex's state/province",
