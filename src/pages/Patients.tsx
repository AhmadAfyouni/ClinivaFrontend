...
import RowData from "../types/Patient";
          ...
          {Array.from({ length: endPage - startPage + 1 }, (_, i) => (
            <button
              ...
              style={{
                ...
                height: "30px",
                backgroundColor:
                  currentPage === startPage + i ? "#d1fae5" : "white",
                border: "1px solid #e5e7eb",
                borderRadius: "50%",
                cursor: "pointer",
              }}
            ...
            <Table.Tr>
              <Table.Th>
                <Checkbox
                  ...
                  color={
                    selection ? theme.other.secondaryColor : theme.other.bg
                  }
                  w="12px"
                  h="12px"
                  size="12px"
              ...
              <Flex w="97%" justify="space-between">
                ...
                <Th
                  sorted={sortBy === "treatment"}
                  reversed={reverseSortDirection}
                  onSort={() => setSorting("treatment")}
                  style={{
                    padding: "16px 4px",
                    color: theme.other.onSurfaceTertiary,
                    fontWeight: "normal",
